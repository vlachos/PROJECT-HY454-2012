// C++ ALLEGRO 5 MADE EASY TUTORIAL 29 - ROTATING THE CAMERA
// CODINGMADEEASY
	...
	while(!done)
	{
		...
		else if (events.type == ALLEGRO_EVENT_TIMER)
		{
			if(events.timer.source == timer)
			{
				...
				al_translate_transform(&camera, -(x + 16) , -(y + 16));
				al_rotate_transform(&camera, degrees * 3.1415 / 180);
				al_translate_transform(&camera, -cameraPosition[0] + (x+ 16), 
					-cameraPosition[1] + (y + 16));
