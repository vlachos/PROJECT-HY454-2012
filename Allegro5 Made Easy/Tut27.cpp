...
int main()
{
	...
	ALLEGRO_BITMAP *player2 = al_clone_bitmap(player);
	...
	while(!done)
	{
		...
		if(draw)
		{
			...
			al_draw_rotated_bitmap(subBitmap, 16, 16, x, y, degrees * 3.1415 / 180, NULL);
			al_draw_tinted_bitmap(subBitmap, al_map_rgb(255, 0, 0), x, y, NULL);
